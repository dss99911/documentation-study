:gitplant: http://www.plantuml.com/plantuml/proxy?src=https://raw.githubusercontent.com/dss99911/markdown/master/
...
.In your document
 image::{gitplant}/asciidoc/test.puml[test]

.Result
image::{gitplant}/asciidoc/test.puml[PlantUML Image]
